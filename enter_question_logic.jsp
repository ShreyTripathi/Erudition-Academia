...
<%
		...
		String ans = request.getParameter("correct_answer").toLowerCase();
		...
		try{	
			...
			int i = st.executeUpdate("insert into question(det,choice1,choice2,choice3,choice4,correct_answer,diff_level,topic_name) values('"+det+"','"+ch1+"','"+ch2+"','"+ch3+"','"+ch4+"','"+ans+"','"+diff_level+"','"+topic+"')");
