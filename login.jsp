										...
										<form class="form-horizontal" role="form" action="login_logic.jsp" method="POST">
											...
											<div class="form-group">
												<label for="inputUserId" class="col-sm-3 control-label">
													User ID</label>
												<div class="col-sm-9">
													<input type="text" class="form-control" id="inputUserId" placeholder="User Id" name="uId" required="required"></div>
												</div>
												<div class="form-group">
													<label for="inputPassword" class="col-sm-3 control-label">
														Password</label>
													<div class="col-sm-9">
														<input type="password" class="form-control" id="inputPassword" placeholder="Password" name="pwd" required="required"></div>
													</div>
